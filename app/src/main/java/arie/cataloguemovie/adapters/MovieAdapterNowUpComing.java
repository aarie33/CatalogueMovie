...
public class MovieAdapterNowUpComing extends RecyclerView.Adapter<MovieAdapterNowUpComing.MyViewHolder> {
    public Context ctx;
    public ArrayList<MovieItems> list;

    public MovieAdapterNowUpComing(Context ctx, ArrayList list) {
        this.ctx = ctx;
        this.list = list;
    }
