...
public class MovieBanner extends AppWidgetProvider {
    public static final String TOAST_ACTION = "arie.cataloguemovie.widgets.TOAST_ACTION";
    public static final String EXTRA_ITEM = "arie.cataloguemovie.widgets.EXTRA_ITEM";
